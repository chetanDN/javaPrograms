...
/*
@SuppressWarnings("unchecked")
Sometimes Java generics interface just doesn't let you do what you want to, and you need to effectively tell the compiler that what you're doing really will be legal at execution time.

here passing sub iterator to print only string
therefore we are breaking and passing at

if(element instanceof String)//Hints: use instanceof operator

we can also do by
if(element.equal("###")) at where we need to break it
